...
| moreInformation | no       |         | An optional extension to the description to allow an extended description for the type. This can be spread over multiple lines and supports markdown. It is used to provide help in various parts of the biz-ops ecosystem, including item creation and view in the admin ui                                    |                                                   |
