...
const initShowInactiveButtons = () => [...document.querySelectorAll('button.show-inactive-button')].forEach(button => {
  const inactiveCount = button.closest('dd').querySelectorAll('.inactive').length;
