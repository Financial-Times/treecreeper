# @financial-times/treecreeper-schema-sdk
...
`npm install @financial-times/treecreeper-schema-sdk`
...
```js
const { init, ready } = require('@financial-times/treecreeper-schema-sdk');
init({
