...
test-pkg-rest-handlers:
	TREECREEPER_SCHEMA_DIRECTORY=example-schema DEBUG=true TIMEOUT=500000 jest "packages/api-rest-handlers/__tests__/log-changes.spec.js" --testEnvironment=node --watch; \
